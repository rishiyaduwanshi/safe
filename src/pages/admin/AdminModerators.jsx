...
import { Plus, Save, ToggleLeft, Trash2, Shield, CircleAlert } from 'lucide-react';
                                        ...
                                        <td className="px-4 py-4">
                                            <div className="flex flex-wrap gap-2">
                                                ...
                                                <button
                                                    ...
                                                    className="inline-flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg border border-white/16 text-slate-200"
                                                >
                                                    <ToggleLeft size={13} /> Toggle
                                                </button>
                                                <button
