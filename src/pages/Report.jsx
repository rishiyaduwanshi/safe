                  ...
                  {!submitted ? (
                    <>
                      <form onSubmit={handleFormSubmit(onSubmit)}>
                        ...
                        {/* Location Section */}
                        <div className="mb-6 p-4 bg-background-secondary rounded-xl border border-white/8">
                        ...
                        >
                          {isSubmitting ? (
                            <div className="flex items-center justify-center gap-2">
                              <div className=" border-2 border-transparent border-t-current rounded-full animate-spin" />
